                ...
                <div class="s-content__author">
                    ...
                    <div class="s-content__author-about">
                        ...
                        <ul class="s-content__author-social">
                            ...
                            $philosophy_author_github = get_field('github','user_'.get_the_author_meta('ID'));
                            ?>
	                        ...
	                        <?php endif; ?>
	                        <?php if($philosophy_author_github): ?>
                                <li><a href="<?php echo esc_url($philosophy_author_github); ?>">Github</a></li>
	                        <?php endif; ?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="s-content__pagenav">
                    <div class="s-content__nav">
                        <div class="s-content__prev">
                            <?php
                                $philosophy_pre_post = get_previous_post();
                                if($philosophy_pre_post):
                            ?>
                            <a href="<?php echo get_the_permalink($philosophy_pre_post); ?>" rel="prev">
                                <span><?php _e('Previous Post','philosophy') ?></span>
                                <?php echo get_the_title($philosophy_pre_post); ?>
                            </a>
                               <?php endif; ?>
                        </div>
