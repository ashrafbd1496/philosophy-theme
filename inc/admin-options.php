...
CSF::createOptions($prefix, array(
  ...
  'menu_type' => 'menu',
  'frmawork_title' => __('Philosophy Options','philosophy'),
  'menu_slug' => 'philosophy_options',
  'icon'=>'fas fa-bars',
  'menu_position'=>6,
  'ajax_save'=>false,
  'admin_bar_icon'=>'fas fa-home',
...
CSF::createSection($prefix, array(
  ...
  'fields' => array(
    ...
    array(
      'id' => 'footer_tags',
      'type' => 'switcher',
      'title' => __('Tags are visible ?','philosophy'),
      'default'=>0,
    ),
...
CSF::createSection($prefix,array(
  ...
  'title'=>'Header Backroud',
  'fields'=>array(
    array(
      'id'=>'header_backround',
      'type'=>'background',
      'title'=>__("Header Background/Image"),
      'output'=>array('.header'),
    ),
  )
));
...
//
// Field: text
//check output at the page http://127.0.0.1/wordpress/codetar-fileds-practice-examples/
//
CSF::createSection($prefix, array(
  'parent' => 'basic_fields',
  'title' => 'Upload',
  'icon' => 'far fa-square',
  'description' => 'Visit documentation for more details on this field: <a href="http://codestarframework.com/documentation/#/fields?id=upload" target="_blank">Field: text</a>',
  'fields' => array(
    ...
    array(
      ...
      'settings' => array(
        ...
        'button_title' => __('Add Image', 'philosophy'),
        'frame_title' => 'Select a PDF',
        'insert_title' => 'Inset this PDF',
    ...
    array(
      'id' => 'upload_image',
      'type' => 'media',
      'title' => __('Upload an Image', 'philosophy'),
      'library' => 'image',
      'placeholder' => 'http://',
      'button_title' => __('Add an Image', 'philosophy'),
      'remove_title' => __('Remove Image', 'philosophy'),
    ),
    array(
      'id' => 'gallery',
      'type' => 'gallery',
      ...
      'clear_title' => __('Remove Images', 'philosophy'),
    ),

    array(
      'id' => 'codestar_header_option',
      'type' => 'fieldset',
      'title' => 'Codestar Heding Option',
      'fields' => array(
        array(
          'id' => 'codestarpage_heading',
          'type' => 'text',
          'title' => 'Codestar Heading',
        ),
        ...
        array(
          ...
          'title'  => 'Heading Color',
          'output' => '.heading_3',
          'dependency'=>array('show_heading','==','1'),
