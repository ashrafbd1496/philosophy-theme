        ...
        <article class="row format-standard">
            ...
            <div class="s-content__header col-full">
                ...
                <?php 
                          ...
                          $heading_option = $options['codestar_header_option'];                          
                            echo $heading_option['codestarpage_heading'];                          
            ...
            <div class="col-full s-content__main">
                ...
                //To show upload file using codestar
                $options = get_option('philosophy_options');
                echo $upload_pdf_file = $options['upload']['url'];
                 ...
                 <img src="<?php echo $upload_image['url']; ?>" alt="Philosophy">  
    
                 <?php
                   echo "<br/>";
                   //gallery field
                   
                 $gallery_images = $options['gallery']; 
